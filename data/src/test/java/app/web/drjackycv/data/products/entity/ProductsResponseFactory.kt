...
class ProductsResponseFactory {
    ...
    companion object {
        ...
        fun providesProductDetailResponse(
            id: Int = 309396011,
            price: String = "1.45",
            title: String = "Ocado Organic Fairtrade Bananas",
            imageUrl: String = "https://mobile.ocado.com/webservices/catalogue/items/item/309396011/images/image/0/360x360.jpg",
        ...
        private fun providesItemResponse(
            ...
            imageUrl: String = "https://mobile.ocado.com/webservices/catalogue/items/item/309396011/images/image/0/240x240.jpg"
        ) = Item(
            id = id,
            price = price,
            title = title,
